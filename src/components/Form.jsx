      ...
      <Form onSubmit={handleSubmit}>
        {page === 1 && (
          ...
          <div className='d-flex flex-column align-items-center justify-content-center '>
            <h1 class ="mt-5 text-center">Personal Details</h1>
            ...
            <Button variant="primary"className='mt-3  align-self-end ' onClick={handleNext}>
              Next
            </Button>
          </div>
          </div>
        ...
        {page === 2 && (
          ...
          {/* <div className='d-flex flex-column align-items-center'> */}
            <h1 className="mb-4">Address Section</h1>
            ...
            <Button variant="secondary" onClick={handlePrevious} className='mt-3 mx-3  align-self-start'>
              Previous
            </Button>
            <Button variant="primary" onClick={handleNext} className='mt-3 mx-3 align-self-end'>
              Next
            </Button>
            </div>
          {/* </div> */}
          ...
          {/* <div className='d-flex flex-column align-items-center'> */}
            ...
            <Form.Group controlId="cardNumber">
              ...
              <Form.Control
                ...
                onChange={(e) => handleChange('paymentDetails', 'cardNumber', e.target.value)}
              />
            </Form.Group>
            ...
            <Form.Group controlId="cardNumber">
              ...
              <Form.Control
                ...
                onChange={(e) => handleChange('paymentDetails', 'expiryDate', e.target.value)}
              />
            </Form.Group>
            <div>
            ...
            <Button variant="primary" type="submit" onClick={handleNext} className='mt-3  mx-3   align-self-end'>
              Submit
            </Button>
            </div>
          {/* </div> */}
